...
class Item extends Unit
{
    ...
    {
        $object_class = new Post($this->showField('object_class'));
    ...
    {
        $region = new Post($this->showField('region'));
    ...
    {
        $law_type = new Post($this->showField('law_type'));
    ...
    {
        $parking_type = new Post($this->showField('parking_car_type'));
    ...
    {
        $direction = new Post($this->showField('direction'));
    ...
    public function metroYandex()
    {
        ...
        $metro = new Post($this->showField('metro'));
    ...
    {
        $highway = new Post($this->showField('highway'));
    ...
    {
        $railwayStation = new Post($this->showField('railway_station'));
    ...
    {
        $owner = new Post($this->showField('clyent_id'));
    ...
    {
        $ventilation = new Post($this->showField('ventilation'));
    ...
    {
        $internet = new Post($this->showField('internet'));
    ...
    {
        $tel = new Post($this->showField('telephony'));
    ...
    {
        $water = new Post($this->showField('water'));
    ...
    {
        $heating = new Post($this->showField('heating'));
    ...
    {
        $entry = new Post($this->showField('entry_territory'));
    ...
    {
        $facing = new Post($this->showField('facing_type'));
    ...
    {
        $guard = new Post($this->showField('guard'));
    ...
    {
        $sewage = new Post($this->showField('sewage'));
    ...
    {
        $status = new Post($this->showField('item_status'));
