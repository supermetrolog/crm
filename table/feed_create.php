...
while ($block = $sql->fetch(PDO::FETCH_LAZY)) {
    ...
    */
    ...
    $values_arr[] = $offer->getField('built_to_suit') == 1 ? 1 : 0;
    //
    ...
    $values_arr[] = $price_min ? $price_min : $block->price_field_min;
    //
    $fields_arr[] = 'price_floor_max';
    $values_arr[] =  $price_max ? $price_max : $block->price_field_max;
    ...
    $values_arr[] = ($block->price_sale_min ? $block->price_sale_min : $block->price_field_min);
    //
    $fields_arr[] = 'price_sale_max';
    $values_arr[] = $block->price_sale_max ? $block->price_sale_max : $block->price_field_max;
    //
    ...
    //
    $fields_arr[] = 'ad_avito';
    $values_arr[] = $block->ad_avito;
    //
    $fields_arr[] = 'is_fake';
    $values_arr[] = $block->is_fake_new;
    //
...
while ($offer = $sql->fetch(PDO::FETCH_LAZY)) {
    ...
    if (1) {
        ...
        //
        $fields_arr[] = 'built_to_suit';
        $values_arr[] = $offer_obj->getField('built_to_suit')  == 1 ? 1 : 0;
        //
        $fields_arr[] = 'built_to_suit_time';
        ...
        */
        ...
        $fields_arr[] = 'price_floor_min';
        $values_arr[] = $price_min ? $price_min : $offer_obj->getOfferBlocksMinValue('price_field_min');
        //
        $fields_arr[] = 'price_floor_max';
        $values_arr[] = $price_max ? $price_max :  $offer_obj->getOfferBlocksMaxValue('price_field_max');
        ...
        //
        $fields_arr[] = 'price_sale_min';
        $values_arr[] = $offer_obj->getOfferBlocksMinValue('price_sale_min') ? $offer_obj->getOfferBlocksMinValue('price_sale_min') : $offer_obj->getOfferBlocksMinValue('price_field_min');
        //
        $fields_arr[] = 'price_sale_max';
        $values_arr[] = $offer_obj->getOfferBlocksMaxValue('price_sale_max') ? $offer_obj->getOfferBlocksMaxValue('price_sale_max') : $offer_obj->getOfferBlocksMaxValue('price_field_max');
        //
        $fields_arr[] = 'price_sale_min_all';
        ...
        //
        $fields_arr[] = 'last_update';
        $theMostFreshBlock = $offer_obj->getOfferBlocksMaxValueAll('last_update');
        $values_arr[] = $offer_obj->getField('last_update') > $theMostFreshBlock ? $offer_obj->getField('last_update') : $theMostFreshBlock;

        //
        $fields_arr[] = 'ad_realtor';
        //$values_arr[]= $offer_obj->getField('ad_realtor');
        //$values_arr[]= $offer_obj->adOnRealtor();
        $values_arr[] = $offer_obj->getOfferBlocksMaxValue('ad_realtor');
        //
        $fields_arr[] = 'ad_cian';
        //$values_arr[]= $offer_obj->getField('ad_cian');
        $values_arr[] = $offer_obj->getOfferBlocksMaxValue('ad_cian');
        //
        $fields_arr[] = 'ad_cian_top3';
        //$values_arr[]= $offer_obj->getField('ad_cian_top3');
        $values_arr[] = $offer_obj->getOfferBlocksMaxValue('ad_cian_top3');
        //
        $fields_arr[] = 'ad_cian_premium';
        ...
        //
        $fields_arr[] = 'ad_yandex';
        $values_arr[] = $offer_obj->getOfferBlocksMaxValue('ad_yandex');
        //
        $fields_arr[] = 'ad_avito';
        $values_arr[] = $offer_obj->getOfferBlocksMaxValue('ad_avito');
        //
        $fields_arr[] = 'is_fake';
        $values_arr[] = $offer_obj->getOfferBlocksMaxValue('is_fake');
        //
        $fields_arr[] = 'ad_yandex_raise';
        ...
        $values_arr[] = $offer_obj->getOfferBlocksMaxValue('ad_arendator');
        //
        $fields_arr[] = 'ad_free';
        //$values_arr[]= $offer_obj->getField('ad_free');
        $values_arr[] = $offer_obj->getOfferBlocksMaxValue('ad_free');
...
if (1) {
    ...
    while ($object = $sql->fetch(PDO::FETCH_LAZY)) {
        ...
        //
        $fields_arr[] = 'power';
        $values_arr[] = (int)((bool)$complex->getField('power_value'));
