        ...
        <div class="search-line-block">
            <form action="/objects/" method="get">
                <div class="search-line flex-box">
                    <input type="text" value="<?=$_GET['search']?>" name="search" placeholder="ID, аресс, собственник, телефон, фио, брокер, название" />
            ...
            <table>
                ...
                <tr>
                    ...
                    <th class="for-area">
                        ...
                        <nobr class="sortel ">
                            <a href="/industry/asc/area_min/1/?scroll2list">
                                <span class="b">субаренды</span>
                            </a>
                        </nobr>
                        <nobr class="sortel ">
                            <a href="/industry/asc/area_min_sale/1/?scroll2list">
                                <span>продажи</span>
                            </a>
                        </nobr>
                        <nobr class="sortel ">
                            <a href="/industry/asc/area_min_safe/1/?scroll2list">
                                <span>ответ.хранения</span>
                            </a>
                        </nobr>
                        -->
                    </th>
                    <th class="for-price">
                        ...
                        <nobr class="sortel">
                            <a href="/industry/asc/sale_price/1/?scroll2list">
                                <span>продажи</span>
                            </a>
                        </nobr>
                        <nobr class="sortel ">
                            <a href="/industry/asc/rent_price_safe/1/?scroll2list">
                                <span>ответ.хранения</span>
                            </a>
                        </nobr>
                        -->
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        document.querySelector(".blocks-dropdown-button").onclick =  function(){
            alert('fdfdf'+this.id);
            alert(document.querySelector(".block_"+this.id));
            document.querySelector(".block_"+this.id).style.display = 'block';
        }
        */
