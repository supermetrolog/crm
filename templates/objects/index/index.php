<? include($_SERVER['DOCUMENT_ROOT'] . '/templates/objects/header/index.php') ?>
<div>
...
<div class="card-photo-area box-vertical" >
    <div class="flex-box flex-wrap files-grid">
        ...
        $obj_photos = $object->getJsonField('photo');
        $photo_num = 0;
        foreach($object->getThumbs('photo') as $thumb){
            $thumb = trim($thumb,'.');
            if(stristr($thumb, 'del') === FALSE &&  $thumb != NULL){?>
                <div class="flex-box files-grid-unit">
                    <div class="flex-box modal-call-btn flex-around background-fix photo-container"  data-modal="photo-slider" data-table="1" data-id="<?=$obj_photos[$photo_num]?>" data-modal-size="modal-big"   style=" background-image: url('<?=PROJECT_URL.$thumb?>') " >
                        <?if($i > 14){?>
                            <div class="isBold" style="font-size: 30px; color: white; cursor: pointer; text-shadow: 1px 1px 2px black, 0 0 1em #000000;  ">
                                +<?=(count($photos) - $i)?>
                                <!--+<?=$object->photoCount() - $i?>-->
            ...
            <div>
                ...
                <? foreach ($floors_exist as $floor) { ?>
                    ...
                    <? if (in_array($floor_obj->getField('title'), $object->getFloorsTitle())) { ?>
                        <div class="icon-orthogonal btn-green" title="Этаж уже добавлен">
                            <?
                            $floor_obj = new Post($floor);
                            $floor_obj->getTable('l_floor_nums');
                    ...
                    <? } else { ?>
                        <div class=" modal-call-btn icon-orthogonal " title="Добавить этаж" data-form="" data-id="" data-table="<?= (new Floor())->setTableId() ?>" data-names='["redirect","object_id","floor_num_id"]' data-values="[1,<?= $object->postId() ?>,<?= $floor ?>]" data-modal="edit-all" data-modal-size="modal-middle">
                            +
                            <?
                            $floor_obj = new Post($floor);
                            $floor_obj->getTable('l_floor_nums');
            ...
            <div class="tabs flex-box">
                <? foreach ($offers as $offer_item) { ?>
                    ...
                    <? if ($_COOKIE['member_id'] == 142) { ?>
                        ...
                        <? } else { ?>
                            <div row-ids='<?= json_encode($offers) ?>' id="<?= $offer->postId() ?>" class="tab offer-tab  <?= ($_GET['offer_id'] == $offer_item) ? 'tab-active' : '' ?>">
                            <? } ?>
                        ...
                        <? if ($_COOKIE['member_id'] == 142) { ?>
                            <script>
                                ...
                                $('body').on('click', '.offer-tab', function() {
                                    ...
                                    let url = 'https://pennylane.pro/object/<?= $object->postId() ?>?' + str;
                        ...
                        <? } else { ?>
                            <script>
                                $('body').on('click', '.offer-tab', function() {
                                    ...
                                    //значение урла
                                    let url = 'https://pennylane.pro/object/<?= $object->postId() ?>?offer_id=' + id;
                        ...
                        <div class="tabs-content">
                            <? foreach ($offers as $offer_item) { ?>
                                ...
                                <? if ($_COOKIE['member_id'] == 142) { ?>
                                    ...
                                    <? } else { ?>
                                        <div class="tab-content offer-tab-content <?= ($_GET['offer_id'] == $offer_item) ? 'tab-content-active' : '' ?>">
                                        <? } ?>
                                        <div class="offer_container full-width">
                                            <div class="offer-summary flex-box flex-wrap flex-vertical-top full-width ">
                                                ...
                                                <div>
                                                    <div class="tab-content accordion">
                                                        ...
                                                        foreach ($sorted as $value) {
                                                            ...
                                                            $floor_obj->getTable('l_floor_nums'); ?>
                                                            <div class="acc-unit">
                                                                <div class="full-width flex-box acc-tab flex-vertical-top " style="box-sizing: border-box; padding: 3px; color: #ffffff">
                                                                    <div style="width: 180px;">

                                                                    </div>
                                                                    <div class="floor-info box-small " style="min-height: 60px; background: <?= $floor_obj->getField('color') ?>;  ">
                                                                        <div class="isBold">
                                                                            <?= $floor_obj->getField('title') ?>
                                                                        </div>
                                                                        <div>
                                                                            <?= numFormat($floor->getField('area_floor_full')) ?> м <sup>2</sup>
                                                                        </div>
                                                                        <div class="flex-box">
                                                                            <div>
                                                                                <div class="pointer modal-call-btn" data-form="" data-id="<?= $floor->postId() ?>" data-table="<?= $floor->setTableId() ?>" data-show-name="company_id" data-modal="edit-all" data-modal-size="modal-middle"><i class="fas fa-pencil-alt"></i></div>
                                                                            </div>
                                                                            <div class="to-end">
                                                                                <div title="создать блок на этаже" class="pointer modal-call-btn" data-form="<?= $deal_forms_blocks_arr[$object->getField('is_land')][$offer->getField('deal_type') - 1] ?>" data-id="" data-table="<?= (new Subitem())->setTableId() ?>" data-names='["floor_id","offer_id","is_land"]' data-values='[<?= $floor->getField('id') ?>,<?= $offer->getField('id') ?>,<?= $object->getField('is_land') ?>]' data-modal="edit-all" data-modal-size="modal-middle"><i class="fas fa-plus-circle"></i></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="flex-box floor-blocks" style="min-height: 60px; width: 100%; overflow-x: scroll;  ">
                                                                        <?
                                                                        ...
                                                                        while ($floor_block = $sql_bl->fetch(PDO::FETCH_LAZY)) { ?>
                                                                            ...
                                                                            <div class="box-small no-shrink" style="height: 100%; width: 200px; background: #000000;">
                                                                                <div>
                                                                                    DACHSER <span class="isBold"><?= numFormat($floor_block->area_floor_max) ?> м <sup>2</sup></span>
                                                                                </div>
                                                                                ...
                                                                                <div class="flex-box">
                                                                                    <div>
                                                                                        <div class="pointer modal-call-btn" data-form="<?= $deal_forms_blocks_arr[$object->getField('is_land')][$offer->getField('deal_type') - 1] ?>" data-id="<?= $floor_block->id ?>" data-table="<?= (new Subitem())->setTableId() ?>" data-show-name="company_id" data-modal="edit-all" data-modal-size="modal-middle"><i class="fas fa-pencil-alt"></i></div>
                                                                                    </div>
                                                                                    <div class="to-end">
                                                                        ...
                                                                        <? } ?>
                                                                        <div class="box-small" style="height: 100%; width: 100%; background: #999999; min-width: 200px;">
                                                                            <div>
                                                                ...
                                                                <div class="acc-content">
                                                                    <div>
                                                                        <div class="box-small isBold" style="background: #f1f6f9; ">
                                                                            Площадь
                                                                        </div>
                                                                        <div class="flex-box  blocks-stats flex-vertical-top">
                                                                            <div class="box-small no-shrink" style="width: 150px;">
                                                                                <ul>
                                                                                    <li>S-складская</li>
                                                                                    <li>S-офисная</li>
                                                                                    <li>S-техническая</li>
                                                                                    <li>S-уличного хран</li>
                                                                                    <li>N-паллет-мест</li>
                                                                                </ul>
                                                                            </div>
                                                                            <div class="box-small no-shrink" style="width: 150px;">
                                                                                <ul>
                                                                                    <li>1 120 -3 860 м кв</li>
                                                                                    <li>1 000 -3 600 м кв</li>
                                                                                    <li>120 -260 м кв</li>
                                                                                    <li>120 -6000 м кв</li>
                                                                                    <li>16 000 п м</li>
                                                                                </ul>
                                                                            </div>
                                                                            <? foreach ($floor_blocks as $floor_block) { ?>
                                                                                <? $obj_block = new Subitem($floor_block) ?>
                                                                                <div class="box-small no-shrink" style="width: 200px;">
                                                                                    <ul>
                                                                                        <li><?= numFormat($obj_block->getField('area_floor_max')) ?> м кв</li>
                                                                                        <li><?= numFormat($obj_block->getField('area_office_max')) ?> м кв</li>
                                                                                        <li><?= numFormat($obj_block->getField('area_tech_max')) ?> м кв</li>
                                                                                        <li><?= numFormat($obj_block->getField('area_field_max')) ?> м кв</li>
                                                                                        <li><?= numFormat($obj_block->getField('pallet_place_max')) ?> п м</li>
                                                                                    </ul>
                                                                                </div>
                                                                            <? } ?>
                                                                            <div class="box-small" style="width: 100%;">
                                                                                <ul>
                                                                                    <li>1 120 -3 860 м кв</li>
                                                                                    <li>1 000 -3 600 м кв</li>
                                                                                    <li>120 -260 м кв</li>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="flex-box  blocks-stats flex-vertical-top">
                                                                            <div class="box-small no-shrink" style="width: 150px;">
                                                                                <ul>
                                                                                    <li>Ставка складская</li>
                                                                                    <li>Ставка офисная</li>
                                                                                    <li>Ставка техничекая</li>
                                                                                    <li>Ставка уличная</li>
                                                                                </ul>
                                                                            </div>
                                                                            <div class="box-small no-shrink" style="width: 150px;">
                                                                                <ul>
                                                                                    <li>5 500 м кв/год</li>
                                                                                    <li>12 500 м кв/год</li>
                                                                                    <li>5 500 м кв/год</li>
                                                                                    <li>1200 м кв/год</li>
                                                                                </ul>
                                                                            </div>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="flex-box  blocks-stats flex-vertical-top">
                                                                            <div class="box-small no-shrink" style="width: 150px;">
                                                                                <ul>
                                                                                    <li>Высота хранения</li>
                                                                                    <li>Тип пола</li>
                                                                                    <li>Нагрузка на пол</li>
                                                                                    <li>Сетка колонн</li>
                                                                                    <li>Тип, кол-во ворот</li>
                                                                                    <li>Темп хранения</li>
                                                                                    <li>Вход в блок</li>
                                                                                </ul>
                                                                            </div>
                                                                            ...
                                                                            <? foreach ($floor_blocks as $floor_block) { ?>
                                                                                ...
                                                                                <div class="box-small no-shrink" style="width: 200px;">
                                                                                    <ul>
                                                                                        <li><?= numFormat($obj_block->getField('ceiling_height_max')) ?> м </li>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="flex-box  blocks-stats  flex-vertical-top">
                                                                            ...
                                                                            <? foreach ($floor_blocks as $floor_block) { ?>
                                                                                ...
                                                                                <div class="box-small no-shrink" style="width: 200px;">
                                                                                    <ul>
                                                                                        <li><?= ($obj_block->getField('racks')) ? 'стеллажирован' : '-' ?></li>
                                                    ...
                                                    <div class="full-width">
                                                        <div class="tabs">
                                                            <div class="card-blocks-list flex-box flex-vertical-top" style="  overflow-x: scroll; overflow-y: hidden; ">
                                                                ...
                                                                <? } ?>
                                                                <? if ($logedUser->isAdmin()) { ?>
                                                                    <div class="object-block" style=" flex-wrap: nowrap">
                                                                        <div class="box" style="width: 170px !important; background: #e1e1e1; color: #FFFFFF; flex-wrap: nowrap">
                                                                            <? $obj_block = new Subitem(0) ?>
                                                                            <div style="color: #3b5998;" class="pointer modal-call-btn" data-form="<?= $deal_forms_blocks_arr[$object->getField('is_land')][$offer->getField('deal_type') - 1] ?>" data-id="" data-modal="edit-all" data-table="<?= $obj_block->setTableId() ?>" data-names='["offer_id","object_id"]' data-values='[<?= $offer->getField('id') ?>,<?= $offer->getField('object_id') ?>]' data-modal-size="modal-middle">
                                                                                Добавить блок
                                                                            </div>
                                                                        </div>
                                                                        <div style="border: 1px solid #79a768">
                                                                            ...
                                                                            <div class="box" style="border-bottom: 1px dashed #b5b5b5">
                                                                                <div style="color: #b8312f;">
                                                                                    <form action="<?= PROJECT_URL ?>/system/controllers/subitems/merge.php" method="get">
                                                                                        <input class="blocks-parts" required type="hidden" name="blocks">

                                                                                        <button class="btn-free">Создать связь нестрогую</button>
                                                                                    </form>
                                                                                    <form action="<?= PROJECT_URL ?>/system/controllers/subitems/merge.php" method="get">
                                                                                        <input class="blocks-parts" required type="hidden" name="blocks">
                                                                                        <input type="hidden" name="stack_strict" value="1">
                                                                                        <button class="btn-free">Создать связь строгую</button>
                                                                                    </form>
                                                                                </div>
                                                                            </div>
                                                                            <div class="box obj-block-stats">
                                                                                <ul>
                                                                                    <li></li>
                                                                                    <li></li>
                                                                                    <li></li>
                                                                            ...
                                                                            <div class="box obj-block-stats" style="border-bottom: 1px solid #cfcfcf; border-top: 1px solid #cfcfcf;">
                                                                                <ul>
                                                                                    <li></li>
                                                                                </ul>
                                                                            </div>
                                                                            ...
                                                                            <div class="flex-box box" style="padding: 35px 0;">
