...
//$test =  file_get_contents("https://static-maps.yandex.ru/1.x/?ll=$latitude,$longitude&size=275,450&z=13&l=map&pt=$latitude,$longitude,,vkbkm");
    ...
    <div class="pdf-container-hidden">
        <div class="pdf-block box-small-wide">
            <div class="flex-box flex-vertical-top">
                <div class=" background-fix pdf_photo-big text_left" style=" width: 771px; height: 600px; position: relative;  background: url('<?=photoHelper(PROJECT_URL.(($offer->getJsonField('photos'))[0]))?>')">
                    <div class="box-small object-id uppercase" style=" color: white; width: 150px">
                    ...
                    <div class="box" style=" color: white;">
                        <div class="uppercase" style="font-size: 50px; font-weight: bold;">
                            <?=$offer->getField('title')?>- ТЕСТ
                        </div>
                        <div class="purple-color box-small-vertical" style="font-size: 22px;">
                ...
                <div  style="height: 600px; width: 10px;">

                </div>
                <div class=""  style="height: 600px; width: 379px;  background-image: url('https://pennylane.pro/map.png'); " >

                </div>
            </div>
        </div>
        <div class="pdf-block">
            <div class="box-small flex-box flex-between" >
                <div class="flex-box "  style=" border: 2px solid  #e7e5f2;  ">
                    <div class="box" style="background: #e7e5f2; height: 150px; width: 320px;">
                        <div class="isBold uppercase" style="font-size: 20px;">
                            площади
                            <?
                            if(1){
                        ...
                        <div class="isBold box-small-vertical" style="font-size: 30px">
                            <?=$area?> <span >м<sup>2</sup></span>
                        </div>
                    ...
                    <div class=" box" style="width: 451px; height: 150px; font-size: 20px;" >
                        ...
                        <div class="attention isBold box-small-vertical" style="font-size: 30px">
                ...
                <div class=" text-center " style="width: 379px; height:  152px;">
            ...
            <div class="flex-box flex-between">
                <?if(is_file(PROJECT_ROOT.$offer->getJsonField('photos')[1])){?>
                    ...
                    <?foreach($photos as $photo){?>
                        <div class="background-fix pdf_photo-small pdf-photo-row" style="width: 379px; background-image: url('<?=photoHelper($offer->getJsonField('photos')[$photo])?>');">

                        </div>
                        <?if($photo !=3){?>
                            <div  style="height: 150px; width: 11px;">
        ...
        <?if($offer->getJsonField('blocks')){?>
            <div class="pdf-block">
                <div class=" text-center isBold uppercase">
                    <div class="box-small-vertical text-center inline-block" style="border-bottom: 2px solid #9c2b09; width: 230px">
                        Варианты деления
                    </div>
                </div>
            </div>
            <div class="pdf-block">
                <div class="blocks-header  flex-box box-small-vertical " style="font-size: 16px;">
        ...
        <?if($offer->getJsonField('blocks')){?>
            <?if($offer->getJsonField('photos')[4]){?>
                <?$photos = [4,5,6];?>
                <div class="pdf-block flex-box flex-between box-small" >
                    <?foreach($photos as $photo){?>
                        <div class="background-fix pdf_photo-small pdf-photo-row" style="width: 379px; background-image: url('<?=photoHelper($offer->getJsonField('photos')[$photo])?>');">
        ...
        <div class="pdf-block box-small">
            ...
            <div class="box-small-vertical text_left" style="font-size: 20px;">
        ...
        <div class="pdf-block">
            ...
            <?}else{?>
                <div class="text-center background-fix box-shadow-strong" style="padding: 20px; color: white; background-image: url('<?=$offer->getJsonField('photos')[0]?>');  ">
                    ...
                    <div class="box-small-vertical ghost" style="font-size:  15px">
                    ...
                    <div class="uppercase isUnderline box-small-vertical">
                        <a href="http://industry.realtor.ru" style="color: white; font-size: 25px">
                            industry.realtor.ru
                        </a>
                    </div>
                </div>
