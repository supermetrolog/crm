                ...
                <div>
                    <div class="search-line-block"  >
                        <div class="search-line flex-box">
                            <input  style="" value="" class="full-width box filter-input" type="text"  name="search" placeholder="ID, адрес, собственник, телефон, Ф.И.О, брокер, название СК" />
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function reloadCatalog(request) {
        ...
        xhttp.open('GET',"<?=PROJECT_URL?>/blocks/catalog_requests_f5d5b0c8f908aa1ffc574a7fb2ce27e5.php?request="+request,true);
        xhttp.send();
