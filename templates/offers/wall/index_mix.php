...
<?include_once($_SERVER['DOCUMENT_ROOT'].'/templates/offers/selection/index_mix.php');?>
        ...
        <div class="main-table-block">
            ...
            <div class="">
                ...
                foreach($unique_offers as $unique_offer){
                    ...
                    //$offer->getData($unique_offer);
                    require ($_SERVER['DOCUMENT_ROOT'].'/templates/offers/list/index_mix.php');
                }
                $end = microtime(true);
