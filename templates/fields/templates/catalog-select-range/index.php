...
<div class="">
    <select style=" " class="<?= (trim($src[$field->title()])) ? 'field-checked' :'' ?>" <?=($field->getField('field_required') ? 'required' : '')?> name='<?=$field->title()?>[]'>
        <?
        if(trim($arr_value[0])){
    ...
    <div class="flex-box" >
        <div style="border: 1px solid #E0E0DD;  background: #ffffff; ">
            <input style=" width: 83px !important; " class="filter-input" name="<?=$field->title()?>[]" value="<?=$arr_value[1]?>"  type="number" placeholder=" " />
        </div>
        <div>
            -
        </div>
        <div style="border: 1px solid #E0E0DD;  background: #ffffff; ">
            <input style=" width: 83px !important; " class="filter-input" name="<?=$field->title()?>[]" value="<?=$arr_value[2]?>"  type="number" placeholder=" " />
        </div>
        <div class="ghost">
