<div class="record-unit">
                    ...
                    <?if($listRecord->isRepost()){?>
                        ...
                        <div class="box repost">
                            <div class="message-info flex-box">
                                ...
                                <div class="message-stats box-wide">
                                    <div class="">
                            ...
                            <div class="record-header flex-box ">
                                <div class="record-title">
                                    <a href='<?=PROJECT_URL?>/record/<?=$originalRecord->furl()?>/<?=$originalRecord->record_id()?>'>
                    ...
                    <?}else{?>
                        <div class="record-header flex-box">
                            <div class="record-title">
                                <a href='<?=PROJECT_URL?>/record/<?=$listRecord->furl()?>/<?=$listRecord->record_id()?>'>
                                    <?=$listRecord->title()?>
                                </a>
                            </div>
                            <div class="record-time right">
                    ...
                    <?if($listRecord->isRefferTo()){?>
                        ...
                        <div class="ghost">
                            Отзыв на
                            <a class="underlined" href="<?=PROJECT_URL?>/good/<?=$refItem->categoryFurl()?>/<?=$refItem->itemId()?>">
                                <?=$refItem->title()?>
                            </a>
                        </div>
                    <?}?>
                        ...
                        <div class="record-actions flex-box">
                            <div class="record-social-actions flex-box">
                                <div class="action-like">
                                    <form action='<?=PROJECT_URL?>/system/modules/likes/index.php' method='GET'>
                                ...
                                <div class="action-dislike">
                                    <form action='<?=PROJECT_URL?>/system/modules/dislikes/index.php' method='GET'>
                                        <input type='hidden' name='record_id' value='<?=$listRecord->record_id()?>'/>
                                        <input type="hidden" name="type" value="record"/>
                                        <button class=""?>
                                ...
                                <div class="action-repost">
                                    <form action='<?=PROJECT_URL?>/system/modules/reposts/index.php' method='GET'>
                                        <input type='hidden' name='record_id' value='<?=$listRecord->record_id()?>'/>
                                        <button class=""?>
                            ...
                            <div class="record-author right">
                                <?if($listRecord->author() == $logedUser->member_id() || $logedUser->isAdmin()){?>
                                    <div class="ghost delete_post">
                                        <form action="<?=PROJECT_URL?>/system/modules/records/delete.php" method="POST">
                                            <input type="hidden" name="record_id" value="<?=$listRecord->record_id()?>"/>
                                ...
                                <?}else{?>
                                    <?if($logedUser->member_id() > 0){?>
                                        <div>
                                            <form action="<?=PROJECT_URL?>/<div class="record-unit">
                                            <div class="message-info flex-box">
                                                <div class="photo-round photo-small">
                                                    <a href="<?=PROJECT_URL?>/user/<?=$author->member_id()?>/">
                                                        <img  src='<?=$author->avatar()?>'/>
                                                ...
                                                <div class="record-actions flex-box">
                                                    ...
                                                    <div class="record-author right">
                                                        ...
                                                        <?}else{?>
                                                            <?if($logedUser->member_id() > 0){?>
                                                                <div>
                                                                    <form action="<?=PROJECT_URL?>/sustem/modules/records/complain.php" method="POST">
                                                                        <input type="hidden" name="record_id" value="<?=$listRecord->record_id()?>"/>
                                                ...
                                                <div class="comment-form <?=$comment_field?>">
                                                    <div class="room-form box">
                                                        <form action="<?=PROJECT_URL?>/modules/comments/create.php" method="POST">
                                                            ...
                                                            <div class="flex-box">
                                                                <div class="photo_round photo-icon" >
                                                                    <img src="<?=$logedUser->avatar()?>" /?>
                                                                </div>
                                                                <div class="flex-box  box-wide right" style=" flex-grow: 1; flex-shrink: 1; ">
                                            ...
                                            <?}?>
                                        </div>modules/records/complain.php" method="POST">
                                                <input type="hidden" name="record_id" value="<?=$listRecord->record_id()?>"/>
                                                <button title="Пожаловаться на запись">Пожаловаться</button>
                                            </form>
                                        </div>
